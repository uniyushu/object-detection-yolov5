...
# from models.common_quant import *
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                # y = x[i].sigmoid()    # put this line after conv to fuse sigmoid with conv for compiler acceleration
                if self.inplace:
                # if True:
                    ...
                    xy = (y[:,:,:,:, :2] * 2 + self.grid[i]) * self.stride[i]  # xy
